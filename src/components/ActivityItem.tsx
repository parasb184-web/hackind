...
export const ActivityItem = ({ item }: { item: ActivityFeedItem }) => {
  ...
  return (
    <div className="animate-in fade-in slide-in-from-top-3 flex items-start gap-3 rounded-2xl border border-white/8 bg-white/[0.04] px-4 py-3 duration-500">
      ...
      <div className="min-w-0 flex-1">
        <p className="text-sm leading-6 text-white/90">
          ...
          {" was "}
          <span className="text-blue-200">{item.eventType}</span>
          {" by a "}
          <span className="text-white/80">{item.repoType}</span>
        </p>
        <p className="mt-1 text-[11px] uppercase tracking-[0.24em] text-blue-100/35">
